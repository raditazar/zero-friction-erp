          ...
          <div className="panel-head mb-6">
            <div>
              <div className="flex items-center gap-1.5">
                <p className="eyebrow text-[#5A5A5A]">Daftar Rekening & E-Wallet</p>
          ...
          <div className="grid gap-4 md:grid-cols-2 2xl:grid-cols-3">
            {wallets.map((wallet) => {
              ...
              return (
                <div
                  key={wallet.id}
                  className="rounded-xl border border-[#E0DDD6] bg-[#FFFFFF] p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between">
                      <span className="inline-flex items-center rounded-full bg-[#E8E5DF] px-2.5 py-0.5 text-xs font-semibold text-[#1A1A1A] uppercase tracking-wider">
                        {wallet.category}
                      </span>
                      <span className="text-xs text-[#5A5A5A] font-medium">{wallet.provider || "Rekening Utama"}</span>
                    </div>
                  ...
                  <div className="mt-5 flex gap-2 pt-3 border-t border-[#F0EEE9]">
                    ...
                    <button className="btn-compact text-[#DC2626]" onClick={() => onDelete(wallet.id)}>
                      Hapus
                    </button>
                  </div>
                </div>
