      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E0DDD6] bg-[#F0EEE9] p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-extrabold text-[#DC2626] tabular-nums">
              {amount(totalSpent)}
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[#E0DDD6] bg-[#F0EEE9] p-5 shadow-sm">
            ...
            <p
              className={`mt-2 text-3xl font-extrabold tabular-nums ${
                totalAllocated - totalSpent >= 0 ? "text-[#059669]" : "text-[#DC2626]"
              }`}
            >
          ...
          <div className="panel-head mb-6">
            <div>
              <div className="flex items-center gap-1.5">
                <p className="eyebrow text-[#5A5A5A]">Manajemen Anggaran Per Kategori</p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {expenseCategories.map((category) => {
              ...
              return (
                <div
                  key={category.id}
                  className="rounded-xl border border-[#E0DDD6] bg-[#FFFFFF] p-5 shadow-sm flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between">
                      <h4 className="text-base font-bold text-[#1A1A1A]">{category.name}</h4>
                      {isDeficit ? (
                        <span className="inline-flex items-center rounded-full bg-[#FEE2E2] px-2.5 py-0.5 text-xs font-bold text-[#991B1B]">
